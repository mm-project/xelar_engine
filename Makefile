...
ifeq ($(OS),Windows_NT)
	OUT=SimpleGame.exe
	FLAGS=-Wnarrowing -static-libstdc++ -DOS_WINDOWS -lmingw32
...
default:
	...
	clear
	rm -f ./bin/$(OUT) 
	g++ -Wnarrowing -DOS_WINDOWS $(SRCS) -o ./bin/$(OUT) -I ./deps/win/SDL2/include -L ./deps/win/SDL2/lib/win32  -lmingw32 -lSDl2 -static-libgcc -static-libstdc++
